...
for (const file of ["preventivo.html", "privacy-policy.html", "privacy-calcoli-elettrici.html", "privacy-crossumi.html", "cookie-policy.html", "404.html"]) {
  await save(file, load(await readFile(resolve(root, file), "utf8")));
}
const urls = ["", "en/", "sl/", "preventivo.html", "privacy-policy.html", "privacy-calcoli-elettrici.html", "privacy-crossumi.html", "cookie-policy.html"];
