(function () {
  ...
  const translations = {
    it: {
      title:
        "ELETWAVE V2 | Installatori di impianti elettrici, fotovoltaico e sicurezza",
      description:
    ...
    en: {
      title: "ELETWAVE V2 | Electrical, solar and security system installers",
      description:
  ...
  translations.sl = {
    title: "ELETWAVE V2 | Monterji elektricnih, soncnih in varnostnih sistemov",
    description:
